...
class ProductBulkUpdateRequestV2Payload(BaseModel):
    """
    ProductBulkUpdateRequestV2Payload
    """ # noqa: E501
    update_mask: Optional[ProductFieldMask] = Field(default=None, alias="updateMask")
    attributes: Optional[Dict[str, ProtobufAny]] = None
    __properties: ClassVar[List[str]] = ["updateMask", "attributes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductBulkUpdateRequestV2Payload from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductBulkUpdateRequestV2Payload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "updateMask": ProductFieldMask.from_dict(obj.get("updateMask")) if obj.get("updateMask") is not None else None,
            "attributes": dict(
