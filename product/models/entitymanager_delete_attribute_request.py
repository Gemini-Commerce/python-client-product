...
class EntitymanagerDeleteAttributeRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "entityData", "entityId", "code"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EntitymanagerDeleteAttributeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EntitymanagerDeleteAttributeRequest from a dict"""
        if obj is None:
            return None
