...
class ProductAssets(BaseModel):
    ...
    ProductAssets
    """ # noqa: E501
    entries: Optional[List[ProductAssetsEntry]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "entries": [ProductAssetsEntry.from_dict(_item) for _item in obj.get("entries")] if obj.get("entries") is not None else None
        })
        return _obj
