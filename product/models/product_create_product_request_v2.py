...
class ProductCreateProductRequestV2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "entityType", "entityCode", "code", "isConfigurable", "variantAttributes", "isVirtual", "isGiftcard", "hasConfigurator", "urlKey", "maxSaleableQuantity", "attributes", "variants", "mediaVariantAttributes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProductCreateProductRequestV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ProductCreateProductRequestV2 from a dict"""
        if obj is None:
            return None
