...
class ProductProductEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "grn", "entityType", "entityCode", "id", "code", "variantAttributes", "isConfigurable", "isVirtual", "isGiftcard", "hasConfigurator", "urlKey", "mediaVariantAttributes", "attributes", "variants", "mediaGallery", "maxSaleableQuantity", "assets", "createdAt", "updatedAt"]
