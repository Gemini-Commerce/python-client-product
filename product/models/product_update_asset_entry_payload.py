...
class ProductUpdateAssetEntryPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["assetGrn", "localizedAssetGrn", "position", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductUpdateAssetEntryPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductUpdateAssetEntryPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "localizedAssetGrn": ProductLocalizedAsset.from_dict(obj["localizedAssetGrn"]) if obj.get("localizedAssetGrn") is not None else None,
            "position": obj.get("position"),
            "metadata": [ProductAssetsEntryMetadata.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None
        })
