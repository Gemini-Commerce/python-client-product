...
class EntitymanagerGetAttributeOptionsRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        _items = []
        if self.option_ids:
            for _item_option_ids in self.option_ids:
                if _item_option_ids:
                    _items.append(_item_option_ids.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "optionIds": [EntitymanagerGetAttributeOptionsRequestOption.from_dict(_item) for _item in obj["optionIds"]] if obj.get("optionIds") is not None else None
        })
