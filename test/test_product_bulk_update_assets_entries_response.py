...
class TestProductBulkUpdateAssetsEntriesResponse(unittest.TestCase):
    """ProductBulkUpdateAssetsEntriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductBulkUpdateAssetsEntriesResponse:
        """Test ProductBulkUpdateAssetsEntriesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductBulkUpdateAssetsEntriesResponse`
        """
        model = ProductBulkUpdateAssetsEntriesResponse()
        if include_optional:
    ...
    def testProductBulkUpdateAssetsEntriesResponse(self):
        """Test ProductBulkUpdateAssetsEntriesResponse"""
