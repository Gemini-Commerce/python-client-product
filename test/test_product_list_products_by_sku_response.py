...
class TestProductListProductsBySkuResponse(unittest.TestCase):
    """ProductListProductsBySkuResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductListProductsBySkuResponse:
        """Test ProductListProductsBySkuResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductListProductsBySkuResponse`
        """
        model = ProductListProductsBySkuResponse()
        if include_optional:
    ...
    def testProductListProductsBySkuResponse(self):
        """Test ProductListProductsBySkuResponse"""
