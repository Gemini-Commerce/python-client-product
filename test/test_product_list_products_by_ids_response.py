...
class TestProductListProductsByIdsResponse(unittest.TestCase):
    """ProductListProductsByIdsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductListProductsByIdsResponse:
        """Test ProductListProductsByIdsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductListProductsByIdsResponse`
        """
        model = ProductListProductsByIdsResponse()
        if include_optional:
            return ProductListProductsByIdsResponse(
                products = [
                    product.models.product_product_entity.productProductEntity(
                        tenant_id = '', 
                        grn = '', 
                        entity_type = '', 
                        entity_code = '', 
    ...
    def testProductListProductsByIdsResponse(self):
        """Test ProductListProductsByIdsResponse"""
