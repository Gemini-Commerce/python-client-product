...
class TestProductGetProductByCodeResponse(unittest.TestCase):
    """ProductGetProductByCodeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductGetProductByCodeResponse:
        """Test ProductGetProductByCodeResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductGetProductByCodeResponse`
        """
        model = ProductGetProductByCodeResponse()
        if include_optional:
    ...
    def testProductGetProductByCodeResponse(self):
        """Test ProductGetProductByCodeResponse"""
